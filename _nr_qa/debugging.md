...
* Remember that msg's are passed by <i>reference</i> much of the time, see the [article on how `node.send()` works]({% link _nr_qa/how_node-send_works.md %}) for more details.

...
See also: [Tags]({% link github-jekyll/liquid-tags.md | absolute_url %}), [Attributes]({% link github-jekyll/standard-attributes.md %}), [Test Page]({% link github-jekyll/test2.md %})
